		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sohail9744demo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sohail9744demo-display": {
								"semanticObject": "sohail9744demo",
								"action": "display",
								"description": "Optimize Multiple SAPUI5 Apps in One Dashboard",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sohail9744.demo",
									"url": sap.ui.require.toUrl("sohail9744/demo")
								}
							}
						}
					}
